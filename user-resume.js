window.addEventListener('load', () => {
    ...
    let resumeTitle = document.getElementById('resumeTitle');
    ...
    let resResult = document.getElementById('resResult');
    ...
    let resResult2 = document.getElementById('resResult2');
    resResult2.textContent = result2;
    let resSkil1 = document.getElementById('resSkill1');
    resSkil1.textContent = skill1;
    let resSkil2 = document.getElementById('resSkill2');
    resSkil2.textContent = skill2;
    let resSkil3 = document.getElementById('resSkill3');
    resSkil3.textContent = skill3;
    let resSkil4 = document.getElementById('resSkill4');
    resSkil4.textContent = skill4;
    let resLng1 = document.getElementById('resLng1');
    resLng1.textContent = lng1;
    let resLng2 = document.getElementById('resLng2');
    resLng2.textContent = lng2;
    let resCompany = document.getElementById('resCompany');
    resCompany.textContent = company;
    let resdesgination = document.getElementById('resDesignation');
    ...
    let resdesgination2 = document.getElementById('resDesignation2');
    ...
    let resDes2 = document.getElementById('resDes2');
    resDes2.textContent = job2Des;
    let resCertificate1 = document.getElementById('resCertificate1');
    resCertificate1.textContent = certificate1;
    let resCertificate2 = document.getElementById('resCertificate2');
    resCertificate2.textContent = certificate2;
    let resCertificate3 = document.getElementById('resCertificate3');
